...
/**
 * Gera um arquivo JSON com todos os endereços dos contratos implantados
 * para a rede atual. O arquivo raiz: packages/contracts/deployed_contracts.json
 * também cria um arquivo por rede em deployments/<network>/deployed_contracts.json
 */
...
// Executa ao final para sempre capturar o estado pós-deploy/verificação
