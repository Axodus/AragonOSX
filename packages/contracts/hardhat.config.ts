...
// Harmony pode rejeitar txs com gasPrice muito baixo ("transaction underpriced").
// Mantemos um mínimo conservador, e ainda permitimos override via env (em wei).
// Nota: um mínimo muito alto inflaciona o custo intrínseco e pode causar
// "INSUFFICIENT_FUNDS" mesmo com saldo suficiente para um gasPrice realista.
